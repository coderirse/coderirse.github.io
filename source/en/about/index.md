...
type: about
description: Learn more about Li Zhichao
aside: true
...
{% note success %}
Passionate about technology. Keep learning. Keep moving.
{% endnote %}

### About

Sophomore at University of Science and Technology Beijing (USTB), majoring in Mechanical Engineering. Passionate about AI Coding and solving problems with code.
...
- **[USTB]** — Mechanical Engineering, Undergraduate (Sophomore)
- English: **CET-6**

### Contact

{% btn mailto:caeamer@163.com, Send Email, fas fa-envelope, outline %}

---

*Thanks for stopping by! Check out my [Resume](/en/resume/) and [Projects](/en/projects/).*
