...
{% note success %}
技術に情熱を持ち、学び続け、前に進み続ける。
{% endnote %}

### 自己紹介

北京科技大学（USTB）機械工学専攻の2年生。AIコーディングに情熱を持ち、コードで問題を解決することに夢中です。
...
{% btn mailto:caeamer@163.com, メール送信, fas fa-envelope, outline %}

---

*ご覧いただきありがとうございます。[履歴書](/ja/resume/)と[プロジェクト](/ja/projects/)もぜひご覧ください。*
